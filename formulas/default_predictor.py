...
if __name__ == "__main__":
    ...
    def_gen = Default(bassin_len=7)
    def_gen.set_constant(5)
    prediction = def_gen.get_prediction()
    ax.plot(prediction)


    def_gen.add_fact(point=1, val=1)
    def_gen.add_fact(point=2, val=0)
    def_gen.add_fact(point=4, val=3)
